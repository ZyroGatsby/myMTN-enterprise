...
import ManageSubscriptionsAllContent from '@/components/contents/ManageSubscriptionsAll';
...
const panels = [
  { id: 1, content: <ManageSubscriptionsAllContent /> },
  { id: 2, content: 'Data not available ! Play' },
  { id: 3, content: 'Data not available ! mPulse' },
];
...
export default function ManageSubscriptionsPage() {
  ...
  return (
    <DashboardLayout>
      <Seo templateTitle='Manage subscriptions' />
